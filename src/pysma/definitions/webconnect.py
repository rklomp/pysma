...
# AC Side - PV Power measurements
#: Current power generated by the solar panels
pv_power = Sensor("6100_0046C200", "pv_power", unit="W", enabled=False)
...
#: Active power limit of the Inverter
inverter_active_power_limit = Sensor("6180_00522700", "inverter_active_power_limit", unit="W")
